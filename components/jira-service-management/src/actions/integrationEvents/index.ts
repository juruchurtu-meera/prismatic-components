import { acknowledgeIntegrationAlert } from "./acknowledgeIntegrationAlert";
import { addIntegrationAlertNote } from "./addIntegrationAlertNote";
...
export default {
  ...
  closeIntegrationAlert,
  addIntegrationAlertNote,
  getIntegrationAlertRequest,
};
