...
import { selectSalesInvoiceExamplePayload as examplePayload } from "../examplePayloads/dataSources";
import { connection } from "../inputs";
export const selectSalesInvoice = dataSource({
  display: {
    label: "Select Sales Invoice",
    description: "Select a sales invoice from a list of sales invoices.",
  },
  inputs: { connection },
