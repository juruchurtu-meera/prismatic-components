...
export const getEndpoint = (required: boolean, comments?: string) =>
  input({
    ...
    comments:
      comments ||
      "The endpoint URL that will receive webhook event payloads from ClickUp.",
    required,
    clean: util.types.toString,
  });
export const groupIds = input({
  ...
  comments:
    "A comma-separated list of Team IDs (user groups) to retrieve information about specific Teams.",
  required: false,
  clean: util.types.toString,
});
...
export const getStartDateInt = (
  ...
  input({
    ...
    required,
    comments:
      comments || "The task start date as a Unix timestamp in milliseconds.",
    clean: cleanNumber,
  });
...
export const getCalendarId = (required: boolean, comments?: string) =>
  input({
    ...
    comments: comments
      ? comments
      : "The unique identifier for the Calendar View.",
    required,
    clean: util.types.toString,
...
export const getStartDateTime = (
  ...
  input({
    ...
    type: "boolean",
    comments:
      comments || "When true, the start date includes a specific time of day.",
    required,
    clean: util.types.toBool,
    ...(defaultValue !== undefined && { default: `${defaultValue}` }),
  });
...
export const getCanCreateViews = (
  ...
  input({
    ...
    type: "boolean",
    comments:
      comments || "When true, the guest can create new views in shared spaces.",
    required,
    clean: util.types.toBool,
    ...(defaultValue !== undefined && { default: `${defaultValue}` }),
  });
...
export const getContent = (required: boolean, comments?: string) =>
  input({
    ...
    comments:
      comments || "A short description of the List shown beneath its name.",
    required,
    clean: util.types.toString,
  });
...
export const getLinksTo = (required: boolean, comments?: string) =>
  input({
    ...
    comments:
      comments ||
      "An existing task ID to create a linked dependency from this task.",
    required,
    clean: util.types.toString,
  });
...
export const getDueDate = (required: boolean, comments?: string) =>
  input({
    ...
    comments:
      comments || "The deadline for the task, as an ISO 8601 date string.",
    required,
    clean: util.types.toDate,
  });
...
export const getDueDateTime = (
  ...
  input({
    ...
    type: "boolean",
    comments:
      comments || "When true, the due date includes a specific time of day.",
    required,
...
export const orderBy = input({
  ...
  required: false,
  comments:
    "The field used to sort the results. Defaults to ordering by created date.",
  example: "created",
  clean: util.types.toString,
});
...
export const includeClosed = input({
  ...
  default: "false",
  comments:
    "When true, includes closed tasks in the results. Defaults to excluding them.",
  clean: util.types.toBool,
});
export const dueDateGt = input({
  ...
  required: false,
  comments:
    "Filters results to tasks with a due date greater than this Unix timestamp in milliseconds.",
  clean: util.types.toString,
});
export const dueDateLt = input({
  ...
  required: false,
  comments:
    "Filters results to tasks with a due date less than this Unix timestamp in milliseconds.",
  clean: util.types.toString,
});
export const dateCreatedGt = input({
  ...
  required: false,
  comments:
    "Filters results to tasks created after this Unix timestamp in milliseconds.",
  clean: util.types.toString,
});
export const dateCreatedLt = input({
  ...
  required: false,
  comments:
    "Filters results to tasks created before this Unix timestamp in milliseconds.",
  clean: util.types.toString,
});
export const dateUpdatedGt = input({
  ...
  required: false,
  comments:
    "Filters results to tasks updated after this Unix timestamp in milliseconds.",
  clean: util.types.toString,
});
export const dateUpdatedLt = input({
  ...
  required: false,
  comments:
    "Filters results to tasks updated before this Unix timestamp in milliseconds.",
  clean: util.types.toString,
});
export const dateDoneGt = input({
  ...
  required: false,
  comments:
    "Filters results to tasks completed after this Unix timestamp in milliseconds.",
  clean: util.types.toString,
});
export const dateDoneLt = input({
  ...
  required: false,
  comments:
    "Filters results to tasks completed before this Unix timestamp in milliseconds.",
  clean: util.types.toString,
});
export const fieldId = input({
  ...
  required: true,
  comments:
    "The universal unique identifier (UUID) of the Custom Field to set.",
  clean: util.types.toString,
...
export const valueType = input({
  ...
  comments:
    "The data type of the custom field value (e.g. string, number, date).",
  required: false,
  clean: util.types.toString,
});
...
export const getStart = (required: boolean, comments?: string) =>
  input({
    ...
    comments:
      comments ||
      "The start of the time entry as a Unix timestamp in milliseconds.",
    required,
    clean: cleanNumber,
  });
export const getEnd = (required: boolean, comments?: string) =>
  input({
    ...
    comments:
      comments ||
      "The end of the time entry as a Unix timestamp in milliseconds.",
    required,
    clean: cleanNumber,
  });
...
export const tagAction = input({
  ...
  comments:
    "The action to perform on tags. Accepted values: replace, add, or remove.",
  example: "replace",
  required: true,
  clean: util.types.toString,
});
...
export const getFileName = (required: boolean) =>
  input({
    ...
    comments:
      "The filename to use for the attachment, including extension (e.g. my-image.png).",
    type: "string",
    required,
...
export const pollScopeType = input({
  ...
  clean: util.types.toString,
  comments:
    "The scope to poll tasks against: an entire Team (Workspace) or a single List.",
});
