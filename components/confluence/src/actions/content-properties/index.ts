...
export default {
  ...
  createContentPropertyForPage,
  deleteContentPropertyForAttachment,
  deleteContentPropertyForCustomContent,
  deleteContentPropertyForPage,
  getContentPropertiesForAttachments,
  getContentPropertiesForCustomContent,
  getContentPropertiesForPage,
  listContentPropertiesForAttachments,
  listContentPropertiesForCustomContent,
  listContentPropertiesForPage,
  updateContentPropertyForAttachment,
  updateContentPropertyForCustomContent,
  updateContentPropertyForPage,
};
