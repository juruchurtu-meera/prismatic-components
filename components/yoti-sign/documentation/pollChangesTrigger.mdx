This trigger polls [Yoti Sign](https://www.yoti.com/business/sign/) on a configured schedule and emits envelopes that were created since the previous run. It is a convenient alternative to webhooks when a scheduled pull is preferred over an event push.
