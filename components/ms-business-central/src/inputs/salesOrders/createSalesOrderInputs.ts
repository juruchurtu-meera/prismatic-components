...
export const customerNumber = input({
  ...
  required: false,
  comments: "The customer number for the sales order.",
  type: "string",
  example: "10000",
...
export const billToCustomerId = input({
  ...
  required: false,
  comments: "The customer ID for the bill to customer.",
  type: "string",
...
export const currencyCode = input({
  label: "Currency Code",
  required: false,
  comments: "The currency code for the sales order.",
  type: "string",
  example: "USD",
...
export const email = input({
  ...
  required: false,
  comments: "The email address for the sales order.",
  type: "string",
  example: "robert.jr@example.com",
