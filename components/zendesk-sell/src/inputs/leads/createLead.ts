...
export const createLeadInputs = {
  ...
  organizationName: input({
    ...
    comments: "Required only if a lead is an organization. last_name is empty.",
    type: "string",
    required: false,
    clean: util.types.toString,
  }),
  ...
  ownerId: input({
    ...
    example: "12345678",
    comments:
      "Defaults to user's unique identifier of the user who created the lead is created by.",
    type: "string",
    required: false,
    clean: util.types.toString,
  }),
