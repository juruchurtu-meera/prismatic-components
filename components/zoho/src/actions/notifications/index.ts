import { crmDisableNotification } from "./disable";
import { crmEnableNotification } from "./enable";
...
export default {
  ...
  crmUpdateNotification,
  crmDisableNotification,
  crmDisableSpecificNotification,
};
