import { getKnowledgeArticle } from "./getKnowledgeArticle";
import { getKnowledgeArticleAttachment } from "./getKnowledgeArticleAttachment";
...
export default {
  ...
  listFeaturedKnowledgeArticles,
  getKnowledgeArticle,
  listMostViewedKnowledgeArticles,
};
