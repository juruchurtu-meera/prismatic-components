...
export const oauth = oauth2Connection({
  ...
  inputs: {
    authorizeUrl: {
      comments: "The OAuth 2.0 Authorization URL for Microsoft Advertising.",
    ...
    tokenUrl: {
      comments: "The OAuth 2.0 Token URL for Microsoft Advertising.",
    ...
    scopes: {
      comments:
        "The permission scopes for the Microsoft Advertising OAuth application.",
    ...
    clientId: {
      comments:
        "The client ID of the registered OAuth application for Microsoft Advertising.",
      label: "Client ID",
    ...
    clientSecret: {
      comments:
        "The client secret value of the registered OAuth application for Microsoft Advertising.",
